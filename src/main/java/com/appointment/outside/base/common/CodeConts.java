...
public class CodeConts {
	...
	/*订单已经撤销*/
	public final static String ORDER_BACKOUT = "4011";

	public final static String POINT_FEW = "4012";
	...
	/* 短信验证码 */
	public final static String REDIS_CUSTOMER_MOBILEINTERNET_VERIFICATIONCODE = "customer:mobileInternet:verificationcode";
}
